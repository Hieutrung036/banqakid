            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.diachi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="idnd" class="col-sm-3 col-form-label">Người dùng</label>
                            <div class="col-sm-9">
                                <select id="idnd" name="idnd" required class="form-control">
                                    <option value="">Chọn người dùng</option> <!-- Tùy chọn mặc định -->
                                    @foreach ($nguoidung as $nd)
                                        <!-- Lặp qua danh sách người dùng -->
                                        <option value="{{ $nd->idnd }}">{{ $nd->ten }}</option>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select id="idnd" name="idnd" required class="form-control">
                                                            <option value="">Chọn người dùng</option> <!-- Tùy chọn mặc định -->
                                                            @foreach ($nguoidung as $nd)
                                                                <option value="{{ $nd->idnd }}"
                                                                    {{ $nd->idnd == $dc->idnd ? 'selected' : '' }}>
                                                                    {{ $nd->ten }}
                                                                </option>
                                                            @endforeach
                                                        </select>
