...
class diachiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.diachi', compact('diachi', 'nguoidung'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'idnd' => 'required|exists:nguoidung,idnd', // Kiểm tra xem idnd có tồn tại không
        ]);
        ...
        $diachi->idnd = $request->input('idnd');
    ...
    public function update(Request $request, $iddc)
    {
        ...
        $request->validate([
            ...
            'quanhuyen' => 'required|string',
            'tinhthanhpho' => 'required|string',
            'idnd' => 'required|exists:nguoidung,idnd',
        ]);
